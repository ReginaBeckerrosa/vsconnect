...
function CadastroUsuario() {
    ...
    const [logradouro, setLogradoro] = useState<string>("");
    ...
    //formulario para capturar os dados do ususario
    function cadastrarUsuario(event: any) {
        event.preventDefault();
        const formData = new FormData();
        formData.append("nome", nome);
        formData.append("email", email);
        formData.append("passoword", senha);
        ...
        api.post("users", formData)
            ...
            .catch((error: any) => {
                console.log(error);
                alert("Falha ao cadastrar um usuraio")

            })


    // campo para salva o arquivo enviado pelo usuario
                        ...
                        <form className="cad_formulario" method="POST" onSubmit={cadastrarUsuario}>
                            ...
                            <div className="cad_box_input">
                                ...
                                <input
                                    ...
                                    onChange={(e) => setLogradoro(e.target.value)}
                                    required
                                />
                            </div>
